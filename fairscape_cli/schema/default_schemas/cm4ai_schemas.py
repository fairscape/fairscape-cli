...
cm4ai_schema_directory = '/'

apms_loader_edgelist_schema_path = 'cm4ai_schema_apmsloader_ppi_edgelist.json'
apms_loader_gene_node_schema =  'cm4ai_schema_apmsloader_ppi_gene_node_attributes.json'
apms_embedding_schema = 'cm4ai_schema_apms_embedding.json'
...
APMS_LOADER_EDGELIST_SCHEMA = ReadSchema(apms_load_edelist_schema_path)

DEFAULT_SCHEMAS = {
        'ark:59852/schema-cm4ai-apmsloader-ppi-edgelist' : APMS_LOADER_EDGELIST_SCHEMA,
